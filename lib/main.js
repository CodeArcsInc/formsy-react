...
Formsy.Form = React.createClass({
  ...
  submit: function submit(event) {
    ...
    var submitForm = function submitForm() {
      ...
      _this2.setFormPristine(false);
      var model = _this2.getModel();
      _this2.props.onSubmit(model, _this2.resetModel, _this2.updateInputsWithError);
      _this2.state.isValid ? _this2.props.onValidSubmit(model, _this2.resetModel, _this2.updateInputsWithError) : _this2.props.onInvalidSubmit(model, _this2.resetModel, _this2.updateInputsWithError);
    };
  ...
  validateForm: function validateForm(done) {
    var _this4 = this;
    ...
    if (!this.preventValidateForm) {
      ...
      this.inputs.forEach(function (component, index) {
        var validation = _this4.runValidation(component);
        ...
        }, index === _this4.inputs.length - 1 ? onValidationComplete : null);
      });
  ...
  render: function render() {
    var _props = this.props,
        ...
        validateOnMount = _props.validateOnMount,
        validateOnSubmit = _props.validateOnSubmit,
        nonFormsyProps = _objectWithoutProperties(_props, ['mapping', 'validationErrors', 'onSubmit', 'onValid', 'onValidSubmit', 'onInvalid', 'onInvalidSubmit', 'onChange', 'reset', 'preventExternalInvalidation', 'onSuccess', 'onError', 'validateOnMount', 'validateOnSubmit']);
